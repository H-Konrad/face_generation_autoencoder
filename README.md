...
By using different model architectures and training methods this project demonstrates how autoencoders can be used to compress and reconstruct iumages as well as generate new images.

For a in-depth explanaiton of methods and results, see the project report: 
